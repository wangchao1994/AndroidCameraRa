...
package com.example.librarycamera.log;
...
public class LogUtil {
    ...
    private static int getOverrideLevelFromProperty() {
        ...
        try {
            //logLevelFromProperties = SystemProperties.getInt("debug.mtkcam.loglevel", MTKCAM_LOG_LEVEL_DEFAULT);
            logLevelFromProperties = 0;
